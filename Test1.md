...
## Создание коммитов
Для создания коммитов (сохранений) необходимо для начала в терминале прописать добавление сохранения файла git add name_file

После необходимо его сохранить в системе git с помощью командой (git commit -m "Сообщеие к сохранению")
...
## Ветки в Git
Ветки
Необходимо написать для создания git branch (имя ветки)

### Создание ветки
Для перехода между ветками необходимо ввести git checkout Name_branch
...
Софья Главацкая: GitHub при создании нового репозитория подскажет, как это можно сделать
